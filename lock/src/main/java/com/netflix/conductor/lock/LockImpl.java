package com.netflix.conductor.lock;

import com.netflix.conductor.core.sync.Lock;
import com.netflix.conductor.lock.config.LockProperties;
...
public class LockImpl implements Lock {
    ...
    public LockImpl(LockProperties properties, RedissonClient redisson) {
