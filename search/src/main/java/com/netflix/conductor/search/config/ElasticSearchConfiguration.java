 ...
 */
package com.netflix.conductor.search.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.netflix.conductor.dao.IndexDAO;
import com.netflix.conductor.search.dao.index.ElasticSearchIndexDAO;
...
public class ElasticSearchConfiguration {
    ...
    @Bean
    public IndexDAO elasticsearchIndexDAO(
            RestClientBuilder restClientBuilder,
            @Qualifier("elasticsearchRetryTemplate") RetryTemplate retryTemplate,
            ElasticSearchProperties properties,
            ObjectMapper objectMapper) {
        String url = properties.getUrl();
        return new ElasticSearchIndexDAO(
